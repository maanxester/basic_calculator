...
e.grid(row=0, columnspan=3, pady=10)
...
button_subtract = Button(root, text="-", padx=30, pady=20, fg="red", command=lambda: button_click("-"))
button_multiply = Button(root, text="x", padx=28, pady=20, fg="red", command=lambda: button_click("*"))
button_divide = Button(root, text="/", padx=30, pady=20, fg="red", command=lambda: button_click("/"))
